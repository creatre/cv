...
\begin{multicols}{3}{
    ...
    \begin{window}[2,r,\includegraphics[width=1in]{mesmall.eps},]
      ...
      coffe, creativity and optimism, and ofcourse adaptation. You always think
      about what you are trying to solve and then how to get there. Oh she is 
      cute. And then you choose your tools. 

    \end{window}
  \closearticle

  \headline{\it\huge Lund University}
    Mikael has worked for both small and big employers. When I worked at the 
    Robotics department at Lund University, I was the expert on embedded
    system. It was the first job after University  and there were alot of
    responsibility. I had to design the schematics for the embedded systems
    and also make the software for them. The differense between designing
    hardware and software was the development cycles. You get almost instant
    responce if your program workes but you would have to wait a week or two
    before you got your pcb board from the manufacturer. 
    ...
    the good part. I learned alot and I mostly made the right decision, a 
